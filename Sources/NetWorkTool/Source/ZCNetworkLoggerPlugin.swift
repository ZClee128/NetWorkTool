...
public final class ZCNetWorkLoggerPlugin {
...
// MARK: - PluginType
extension ZCNetWorkLoggerPlugin: PluginType {
...
// MARK: - Logging
private extension ZCNetWorkLoggerPlugin {
...
// MARK: - Configuration
public extension ZCNetWorkLoggerPlugin {
    struct Configuration {
        ...
        public static func defaultOutput(target: TargetType, items: [String]) {
            for item in items {
                if item.hasPrefix("Error calling") {
                    print(item)
                } else {
                    print(item)
                }
...
public extension ZCNetWorkLoggerPlugin.Configuration {
